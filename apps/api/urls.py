...
urlpatterns = [
    ...
    path('product-image/<int:pk>/', views.product_image_detail, name='product-image-detail-api'),
    # -- for seller user -- #
    path('seller-users/', views.seller_user_lists, name='seller-users-api'),
    path('seller-users/<str:first_name>/', views.seller_user_detail, name='seller-user-detail-api'),
    # -- for buyer user -- #
